...
Simulation = 'Part2';  % Part2 Code
%Simulation = 'PNJctEqBias';      Not working (wanted to focus on the
%assignment so i didnt spend too long trying to fix that
...
elseif strcmp(Simulation,'Part2')
    eval('Part2');   
